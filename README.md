...
- `images/` — homepage photos, plus a subfolder per session (`images/baby/`, `images/cakesmash/`, `images/family/`, `images/school/`, `images/weddings/`, `images/christmas/`) with 12 gallery photos each, and `images/backdrops/` with 10 square backdrop swatches
